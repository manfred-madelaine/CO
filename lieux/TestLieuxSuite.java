...
public class TestLieuxSuite {
	...
	public static void main(String[] args) throws ErreurTrajet, ErreurHeure {
		...
		res2.liste();
		 ...
		 Trajet res3 = Trajet.meilleur(col, new CompChgt()); res3.liste();
		 System.out.println("\nComparaison de changements entre t4 et t4b");
		 Collection<Trajet> col2 = new ArrayList<Trajet>(); col2.add(t4);
		 col2.add(t4b); Trajet res4 = Trajet.meilleur(col2, new CompChgt());
		 res4.liste();
