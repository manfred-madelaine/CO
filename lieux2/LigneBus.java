...
public class LigneBus {
	...
	private static volatile LigneBus instance = null;
	...
	private LigneBus(String nom) {
	 ...
	 /**
     * Méthode permettant de renvoyer une instance de la classe LigneBus
     * @return Retourne l'instance du singleton.
     */
    public final static LigneBus getInstance(String nom) {

    	if (LigneBus.instance == null) {
           synchronized(LigneBus.class) {
             if (LigneBus.instance == null) {
               LigneBus.instance = new LigneBus(nom);
             }
           }
        }
        return LigneBus.instance;
    }
